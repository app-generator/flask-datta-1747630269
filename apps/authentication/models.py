...
class Users(db.Model, UserMixin):
    ...
    tokenbalance = db.Column(db.Integer, nullable=True)
    tokenssent = db.Column(db.Integer, nullable=True)
    tokensreceived = db.Column(db.Integer, nullable=True)
    datestokenssent = db.Column(db.DateTime, default=db.func.current_timestamp())
